...
(function($) {
	...
	IntlInputPhone.DEFAULTS = {
		...
		template: '<div class="input-group"><div class="input-group-btn dd"><button type="button" id="btn-country" class="btn btn-default  f16 dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="flag @cca2 btn-flag"></span><span class="caret"></span><span class="btn-cc">&nbsp;&nbsp; +@callingCode &nbsp;&nbsp;</span></button> <ul class="dropdown-menu f16">@country_items</ul></div><input type="text" name="phoneNumber" id="phoneNumber" class="form-control phoneNumber" placeholder="" size="25" /><input type="hidden" name="defaultCountry" id="defaultCountry" size="2" value="@cca2" /><input type="hidden" name="carrierCode" id="carrierCode" size="2" value="@callingCode" /></div>'
	}
