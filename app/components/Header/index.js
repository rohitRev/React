      ...
      <div className="header-append">
            ...
            <ul className=" list-inline float-xs-left top-links">
              <li className="list-inline-item dropdown ">
                ...
                <div className="dropdown-menu dropdown-default" aria-labelledby="dropdownMenu1" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                  <a className="dropdown-item waves-effect waves-light" href={ void(0) }>ENGLISH (US)</a>
                  <a className="dropdown-item waves-effect waves-light" href={ void(0) }>ENGLISH (US)</a>
                  <a className="dropdown-item waves-effect waves-light" href={ void(0) }>ENGLISH (US)</a>
                </div>
              </li>
              <li className="list-inline-item dropdown">
                ...
                <div className="dropdown-menu dropdown-default" aria-labelledby="dropdownMenu2" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                  <a className="dropdown-item waves-effect waves-light" href={ void(0) }>$USD</a>
                  <a className="dropdown-item waves-effect waves-light" href={ void(0) }>$USD</a>
                </div>
              </li>
              <li className="list-inline-item waves-effect waves-light">
                <a href={ void(0) } className>| DOWNLOAD APP |</a>
              </li>
              <li className="list-inline-item waves-effect waves-light"><a href={ void(0) }>HELP &amp; SUPPORT </a></li>
            </ul>
          ...
          <div className="row">
            <div className="col-sm-4 col-xs-5 text-nowrap">
              <span className="toggle-btn hidden-sm-down">
                <a href={ void(0) } className data-slide-menu-main=".main-navbar">
              ...
              <button className="button-collapse navbar-toggler hidden-md-up" type="button" data-activates="slide-out"><i className="fa fa-bars"/></button>
              <a href={ void(0) }><img src="/public/img/logo.png" className="img-fluid logo" alt=""/> </a>
            </div>
            <div className="col-sm-8 col-xs-7 position-static">
              <ul className="nav navbar-nav top-nav clearfix hidden-sm-down">
                <li className="nav-item btn-link">
                  <a href={ void(0) } className="order-btn btn waves-effect waves-light btn-warning">order now</a>
                </li>
                <li className="nav-item cart-icon">
                  <a href={ void(0) } className="cart-icon"><img src="/public/img/cart.svg" alt=""/> <span className="hidden-sm-down">cart</span></a>
                </li>
              </ul>
              ...
              <div className="text-lg-center text-md-right text-xs-right mobile-links">
                ...
                <a href={ void(0) } className="cart-icon hidden-md-up"><img src="/public/img/cart.svg" alt=""/><span className="hidden-sm-down">cart</span></a>
        ...
        <div className="off-canvas-menu hidden-md-up" id="menu-mobile">
          <div className="menu-header">
            <ul className="list-inline">
              <li className="list-inline-item">
                <a href={ void(0) } className="btn btn-outline-white text-uppercase">Login</a>
              </li>
              <li className="list-inline-item">
                <a href={ void(0) } className="btn btn-black text-uppercase">sign up</a>
              </li>
            </ul>
            <a data-slide-menu="#menu-mobile" className="icon-off-canvas hidden-md-up"><img src="/public/img/left-arrow-icon.png" alt="left"/></a>
          </div>
          <ul className="list-unstyled off-canvas-menu-list fa-ul">
            <li>
              <a href={ void(0) } data-toggle="dropdown"><i className="fa-li text-xs-center"><img src="/public/img/us-flag.png" alt="left"/></i> English US <i className="fa fa-angle-right fa-fixed-right" aria-hidden="true"/></a>
              <div className="dropdown-menu">
                <a className="dropdown-item" href={ void(0) }><img src="/public/img/us-flag.png" alt=""/> English US</a>
                <a className="dropdown-item active" href={ void(0) }><img src="/public/img/us-flag.png" alt="left"/> English US <i className="fa fa-check"/></a>
                <a className="dropdown-item" href={ void(0) }><img src="/public/img/us-flag.png" alt=""/> English US</a>
                <a className="dropdown-item" href={ void(0) }><img src="/public/img/us-flag.png" alt=""/> English US</a>
                <a className="dropdown-item" href={ void(0) }><img src="/public/img/us-flag.png" alt=""/> English US</a>
              </div>
            ...
            <li>
              <a href={ void(0) } data-toggle="dropdown"> <i className="fa fa-dollar fa-li" aria-hidden="true"/> USD $ <i className="fa fa-angle-right fa-fixed-right" aria-hidden="true"/></a>
              <div className="dropdown-menu">
                <a className="dropdown-item" href={ void(0) }>USD $</a>
                <a className="dropdown-item active" href={ void(0) }>USD $ <i className="fa fa-check"/></a>
                <a className="dropdown-item" href={ void(0) }>USD $</a>
                <a className="dropdown-item" href={ void(0) }>USD $</a>
                <a className="dropdown-item" href={ void(0) }>USD $</a>
              </div>
            ...
            <li>
              <a href={ void(0) }><i className="fa fa-li fa-android" aria-hidden="true"/> Download App</a>
            </li>
            <li>
              <a href={ void(0) }><i className="fa fa-li fa-question-circle" aria-hidden="true"/> Help &amp; Support</a>
            </li>
          </ul>
          <a href={ void(0) } className="btn btn-outline-white main-btn-free">Free Embroidery Designs</a>
        </div>
        <hr className="border"/>
          ...
          <div className="container container-sm">
            <div className="collapse off-canvas-nav navbar-toggleable-xs " id="collapseEx23">
              <div className="navbar-header">
                <button className="navbar-toggler hidden-md-up" type="button" data-toggle="collapse" data-target="#collapseEx23"><i className="fa fa-close"/></button>
                <a href={ void(0) }><img src="/public/img/logo.svg" className="img-fluid logo hidden-xs-up" alt=""/></a>
              </div>
        ...
        <ul id="slide-out" className="side-nav fixed default-side-nav hidden-md-up">
          <div className="logo-wrapper waves-light">
            <a href={ void(0) }><img alt="" src="/public/img/logo.png" className="img-fluid flex-center"/></a>
          </div>
          <ul className="collapsible text-capitalize collapsible-accordion">
            <li><a href>Embroidery Digitizing</a></li>
            <li><a href={ void(0) }>Vector Conversion</a></li>
            <li><a href={ void(0) }>logo design</a></li>
            <li><a href={ void(0) }>free embroidery designs</a></li>
            <li><a href={ void(0) }>pricing</a></li>
            <li><a href={ void(0) }>portfolio</a></li>
            <li><a href={ void(0) }>blog</a></li>
          </ul>
        </ul>
      </div>
