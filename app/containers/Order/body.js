        ...
        <div className="container container-sm">
          <div className="order-page-block">
            ...
            <form className="form-inline-fields">
              ...
              <div className="form-group row">
                <label className="col-xs-3 col-sm-3 col-form-label text-xs-right">Format: <br />
                  <small>Formats list we provide</small>
                </label>
                <div className="col-xs-9 col-sm-9">
                  <div className="select-full sky-blue">
                    ...
                    <span className="select2 select2-container select2-container--default" dir="ltr" style={{width: "57px"}}>
                        ...
                        <span className="select2-selection select2-selection--multiple" role="combobox" aria-haspopup="true" aria-expanded="false" tabIndex="-1">
                          <ul className="select2-selection__rendered">
                            <li className="select2-search select2-search--inline">
                              <input className="select2-search__field" tabIndex="0" autoComplete="off" autoCorrect="off" autoCapitalize="off" spellCheck="false" role="textbox" aria-autocomplete="list" placeholder="e.g. AI, EPS, CDR, PSD, PDF, SVG etc." style={{width: "578px"}} type="search"/>
                            </li>
                          </ul>
                        </span>
                      </span>
              ...
              <div className="form-group row">
                ...
                <div className="col-xs-9">
                  <div className="select-full light-pink">
                    ...
                    <span className="select2 select2-container select2-container--default" dir="ltr" style={{width: "95px"}}>
                      <span className="selection">
                        <span className="select2-selection select2-selection--multiple" role="combobox" aria-haspopup="true" aria-expanded="false" tabIndex="-1">
                          <ul className="select2-selection__rendered">
                            <li className="select2-search select2-search--inline">
                            <input className="select2-search__field" tabIndex="0" autoComplete="off" autoCorrect="off" autoCapitalize="off" spellCheck="false" role="textbox" aria-autocomplete="list" placeholder="e.g. Pique Polo, Cotton, Denim, Canvas, etc." style={{width: "578px"}} type="search"/>
                            </li>
                          </ul>
                        </span>
                      </span>
              ...
              <div className="form-group row">
                ...
                <div className="col-xs-9">
                  <div className="select-full green">
                    ...
                    <span className="select2 select2-container select2-container--default" dir="ltr" style={{width: "96px"}}>
                      <span className="selection">
                        <span className="select2-selection select2-selection--multiple" role="combobox" aria-haspopup="true" aria-expanded="false" tabIndex="-1">
                          <ul className="select2-selection__rendered">
                            <li className="select2-search select2-search--inline">
                              <input className="select2-search__field" tabIndex="0" autoComplete="off" autoCorrect="off" autoCapitalize="off" spellCheck="false" role="textbox" aria-autocomplete="list" placeholder="e.g. Left Chest, Cap Front, Jacket Back, Bag, etc." style={{width: "578px"}} type="search"/>
                            </li>
                          </ul>
                        </span>
                      </span>
                    ...
                    <div className="inner-block-form collapse" aria-expanded="true">
                      ...
                      <div className="block">
                        ...
                        <div className="range-slider">
                          <div className="slider slider-horizontal" id="" style={{marginBottom: '25px'}}>
                            <div className="slider-track">
                              <div className="slider-track-low" style={{left: '0px', width: '0%'}}></div>
                              <div className="slider-selection tick-slider-selection" style={{left: '0%', width: '50%'}}></div>
                              <div className="slider-track-high" style={{right: '0px', width: '50%'}}></div>
                            </div>
                            <div className="tooltip tooltip-main top hide" role="presentation" style={{left: '50%', marginLeft: '0px'}}>
                              <div className="tooltip-arrow"></div>
                              <div className="tooltip-inner">3</div>
                            </div>
                            ...
                            <div className="slider-tick-label-container" style={{marginLeft: '-48.75px'}}>
                              <div className="slider-tick-label" style={{width: '97.5px'}}>Trim all</div>
                              <div className="slider-tick-label" style={{width: '97.5px'}}>1mm</div>
                              <div className="slider-tick-label" style={{width: '97.5px'}}>2mm</div>
                              <div className="slider-tick-label" style={{width: '97.5px'}}>3mm</div>
                              <div className="slider-tick-label" style={{width: '97.5px'}}>No Trim</div>
                            </div>
                            <div className="slider-tick-container">
                              <div className="slider-tick round in-selection" style={{left: '0%'}}></div>
                              <div className="slider-tick round in-selection" style={{left: '25%'}}></div>
                              <div className="slider-tick round in-selection" style={{left: '50%'}}></div>
                              <div className="slider-tick round" style={{left: '75%'}}></div>
                              <div className="slider-tick round" style={{left: '100%'}}></div>
                            </div>
                            <div className="slider-handle min-slider-handle round" role="slider" aria-valuemin="1" aria-valuemax="5" style={{left: '50%'}} aria-valuenow="3" tabIndex="0"></div>
                            <div className="slider-handle max-slider-handle round hide" role="slider" aria-valuemin="1" aria-valuemax="5" style={{left: '0%'}} aria-valuenow="1" tabIndex="0"></div>
                          </div>
                          <input name="somename" data-provide="slider" data-slider-ticks="[1, 2, 3, 4, 5]" data-slider-ticks-labels="[&quot;Trim all&quot;,&quot;1mm&quot;,&quot;2mm&quot;,&quot;3mm&quot;,&quot;No Trim&quot;]" data-slider-min="1" data-slider-max="5" data-slider-step="1" data-slider-value="3" data-slider-tooltip="hide" style={{display: "none"}} data-value="3" defaultValue="3" type="text"/>
                        </div>
              ...
              <div className="form-group row">
                <label className="col-xs-3 col-form-label text-xs-right">Special Notes <span className="hidden-xs-down">(If any):</span>
                  <small className="hidden-sm-up">(If any):</small>
                </label>
                <div className="col-xs-9">
